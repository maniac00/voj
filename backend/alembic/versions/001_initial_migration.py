...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "PROCESSING", "PUBLISHED", "ERROR", name="bookstatus"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_audio_chapters_book_id"), "audio_chapters", ["book_id"], unique=False
    )
    op.create_index(
        op.f("ix_audio_chapters_chapter_id"),
        "audio_chapters",
        ["chapter_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_audio_chapters_id"), "audio_chapters", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_audio_chapters_user_id"), "audio_chapters", ["user_id"], unique=False
    )
