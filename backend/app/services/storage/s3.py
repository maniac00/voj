...
class S3StorageService(BaseStorageService):
    ...
    async def get_cloudfront_signed_url(
        ...
        try:
            ...
            if (
                ...
                and getattr(settings, "CLOUDFRONT_PRIVATE_KEY_PATH", None)
                and os.path.exists(settings.CLOUDFRONT_PRIVATE_KEY_PATH)
            ):
            ...
            cloudfront_signer = CloudFrontSigner(
                settings.CLOUDFRONT_KEY_PAIR_ID, rsa_signer
            )
    ...
    async def health_check(self) -> Dict[str, any]:
        ...
        try:
            ...
            return {"status": "unhealthy", "error": "No AWS credentials found"}
        except ClientError as e:
            ...
            if error_code == "404":
                ...
                return {"status": "unhealthy", "error": "Access denied to bucket"}
            else:
                return {"status": "unhealthy", "error": f"S3 error: {error_code}"}
        except Exception as e:
