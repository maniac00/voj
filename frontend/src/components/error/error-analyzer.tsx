...
export function ErrorAnalyzer({
  ...
  return (
    <div
      className={`border rounded-lg ${getSeverityColor(errorInfo.severity)} ${className}`}
    >
      <div className="p-4">
        {/* 헤더 */}
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-medium">{errorInfo.message}</h4>
        ...
        {isExpanded && (
          <div className="mt-4 space-y-4">
            ...
            {/* 예방 팁 */}
            {errorInfo.preventionTips &&
              errorInfo.preventionTips.length > 0 && (
                <div>
...
export function QuickErrorSolution({
  ...
  return (
    <div
      className={`border border-red-200 bg-red-50 rounded-lg p-3 ${className}`}
    >
      <div className="flex items-start space-x-3">
        <svg
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-1 text-sm text-red-700">{primarySolution}</p>
        </div>
