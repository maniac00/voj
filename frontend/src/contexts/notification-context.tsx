...
function NotificationItem({ notification, onDismiss }: NotificationItemProps) {
  ...
  return (
    <div
      className={`${styles.bg} ${styles.border} border rounded-md p-4 shadow-lg transition-all duration-300 ease-in-out`}
    >
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div
            className={`text-sm ${styles.message} ${notification.title ? "mt-1" : ""}`}
          >
